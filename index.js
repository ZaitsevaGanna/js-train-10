...
function customObjectFromEntries(entries) {
  if (Array.isArray(entries)) {
    const entriesArray = entries.map(([entryKey, entryValue]) => {
      if (typeof entryKey === "number") {
        entryValue = entryKey.toString();
      }
    ...
    let res = Object.fromEntries(entriesArray);
...
function checkOwnership(obj1, obj2, key) {
  let res1 = obj1.hasOwnProperty(key);
  let res2 = obj2.hasOwnProperty(key);
...
console.log(checkOwnership({ a: 1, b: 2, c: 3 }, { a: 1, b: 2, c: 4 }, "d")); // true
